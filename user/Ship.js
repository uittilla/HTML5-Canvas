...
/*
    ...
    this.moveVector = this.velocity.scalarMultiplyNew(1.5);

    this.velocity.x += Math.cos(this.radian) * this._thrust;
    this.velocity.y += Math.sin(this.radian) * this._thrust;
    ...
    this.coords.forEach(function(coords) {
      ...
      // coords.add(this.moveVector);
      // coords.y += this.moveVector.y;
    });*/
}
...
Player.prototype.checkObj = function (a,b,object, context) {
    object.position = object.getCenter();
